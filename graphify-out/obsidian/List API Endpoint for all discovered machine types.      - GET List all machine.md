...
# List API Endpoint for all discovered machine types.      - GET: List all machine

## Connections
- [[.filter_outstanding()]] - `rationale_for` [EXTRACTED]
...
- [[MachineTypesList]] - `rationale_for` [EXTRACTED]
