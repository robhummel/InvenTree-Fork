...
# Mixin class which exposes the model instance to plugin validation.      Any mode
...
- [[PluginValidationMixin]] - `rationale_for` [EXTRACTED]
- [[PurchaseOrderLineItem]] - `uses` [INFERRED]
- [[PurchaseOrderStatus]] - `uses` [INFERRED]
- [[PurchaseOrderStatusGroups]] - `uses` [INFERRED]
- [[RenderChoices_1]] - `rationale_for` [EXTRACTED]
