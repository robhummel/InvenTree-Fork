...
# Return the value of the setting.          Protected settings are returned as '**

## Connections
- [[.to_representation()_1]] - `rationale_for` [EXTRACTED]
...
- [[PluginConfigSerializer]] - `rationale_for` [EXTRACTED]
