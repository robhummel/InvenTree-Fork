...
# StockAssignmentSerializer

## Connections
- [[.save()_59]] - `method` [EXTRACTED]
- [[.validate()_21]] - `method` [EXTRACTED]
- [[.validate_customer()]] - `method` [EXTRACTED]
...
- [[Serializer for assigning one (or more) stock items to a customer.      This is a]] - `rationale_for` [EXTRACTED]
