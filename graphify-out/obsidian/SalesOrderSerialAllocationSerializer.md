...
# SalesOrderSerialAllocationSerializer

## Connections
- [[.save()_12]] - `method` [EXTRACTED]
- [[.validate()_6]] - `method` [EXTRACTED]
- [[.validate_line_item()_1]] - `method` [EXTRACTED]
- [[.validate_shipment()]] - `method` [EXTRACTED]
- [[AddressBriefSerializer]] - `uses` [INFERRED]
- [[CompanyBriefSerializer]] - `uses` [INFERRED]
- [[ContactSerializer]] - `uses` [INFERRED]
- [[DRF serializer for allocation of serial numbers against a sales order  shipment]] - `rationale_for` [EXTRACTED]
