...
# A ParameterTemplate provides a template for defining parameter values against va

## Connections
- [[.is_complete()]] - `rationale_for` [EXTRACTED]
...
- [[ParameterTemplate]] - `rationale_for` [EXTRACTED]
