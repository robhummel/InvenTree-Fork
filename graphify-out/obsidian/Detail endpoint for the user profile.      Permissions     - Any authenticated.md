...
# Detail endpoint for the user profile.      Permissions:     - Any authenticated
...
- [[Part]] - `uses` [INFERRED]
- [[ProjectCodeList]] - `rationale_for` [EXTRACTED]
- [[PurchaseOrderIssue]] - `rationale_for` [EXTRACTED]
...
- [[UserProfileDetail]] - `rationale_for` [EXTRACTED]
