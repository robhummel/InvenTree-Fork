...
## Connections
- [[.test_invalid()_2]] - `method` [EXTRACTED]
- [[.test_valid()_1]] - `method` [EXTRACTED]
...
- [[Unit tests for the stock assignment API endpoint, where stock items are manually]] - `rationale_for` [EXTRACTED]
