...
# PartStocktakeSerializer

## Connections
- [[.__init__()_56]] - `method` [EXTRACTED]
- [[.save()_49]] - `method` [EXTRACTED]
- [[BomItem]] - `uses` [INFERRED]
- [[BomItemSubstitute]] - `uses` [INFERRED]
- [[DataExportSerializerMixin_1]] - `inherits` [EXTRACTED]
...
- [[Serializer for the PartStocktake model.]] - `rationale_for` [EXTRACTED]
