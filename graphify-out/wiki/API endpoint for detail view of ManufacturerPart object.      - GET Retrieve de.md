...
# API endpoint for detail view of ManufacturerPart object.      - GET: Retrieve de

## Connections
- [[.perform_create()]] - `rationale_for` [EXTRACTED]
- [[ActionPluginView]] - `uses` [INFERRED]
- [[AddressSerializer]] - `uses` [INFERRED]
- [[BarcodeGenerate]] - `rationale_for` [EXTRACTED]
...
- [[LabelTemplateMixin]] - `rationale_for` [EXTRACTED]
...
- [[ManufacturerPartDetail]] - `rationale_for` [EXTRACTED]
