...
# StockAssignmentItemSerializer

## Connections
- [[.validate_item()]] - `method` [EXTRACTED]
...
- [[Serializer for a single StockItem with in StockAssignment request.      Here, th]] - `rationale_for` [EXTRACTED]
