...
# SalesOrderCompleteSerializer

## Connections
- [[.get_context_data()_1]] - `method` [EXTRACTED]
- [[.save()_9]] - `method` [EXTRACTED]
- [[.validate()_5]] - `method` [EXTRACTED]
- [[.validate_accept_incomplete()_1]] - `method` [EXTRACTED]
- [[AddressBriefSerializer]] - `uses` [INFERRED]
- [[CompanyBriefSerializer]] - `uses` [INFERRED]
- [[ContactSerializer]] - `uses` [INFERRED]
- [[DRF serializer for manually marking a sales order as complete.]] - `rationale_for` [EXTRACTED]
...
- [[OrderAdjustSerializer]] - `inherits` [EXTRACTED]
