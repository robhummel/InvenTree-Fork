...
# Mixin class for enabling 'bulk create' operations for various models.      Bulk

## Connections
- [[ApiToken]] - `uses` [INFERRED]
- [[ApiTokenSerializer]] - `uses` [INFERRED]
- [[BulkCreateMixin_1]] - `rationale_for` [EXTRACTED]
...
- [[TokenDetailView]] - `rationale_for` [EXTRACTED]
