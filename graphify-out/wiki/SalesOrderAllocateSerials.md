...
# SalesOrderAllocateSerials

## Connections
- [[API endpoint to allocation stock items against a SalesOrder, by specifying seria]] - `rationale_for` [EXTRACTED]
...
- [[SalesOrderContextMixin]] - `inherits` [EXTRACTED]
