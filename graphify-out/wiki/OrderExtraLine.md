...
## Connections
- [[Abstract Model for a single ExtraLine in a Order.      Attributes         price]] - `rationale_for` [EXTRACTED]
...
- [[PurchaseOrderExtraLine]] - `inherits` [EXTRACTED]
- [[PurchaseOrderStatus]] - `uses` [INFERRED]
- [[PurchaseOrderStatusGroups]] - `uses` [INFERRED]
- [[ReturnOrderEvents]] - `uses` [INFERRED]
- [[ReturnOrderExtraLine]] - `inherits` [EXTRACTED]
...
- [[SalesOrderExtraLine]] - `inherits` [EXTRACTED]
