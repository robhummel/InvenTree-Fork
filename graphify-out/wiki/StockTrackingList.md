...
- [[.get_delta_model_map()]] - `method` [EXTRACTED]
- [[.list()_3]] - `method` [EXTRACTED]
- [[API endpoint for list view of StockItemTracking objects.      StockItemTracking]] - `rationale_for` [EXTRACTED]
...
- [[SerializerContextMixin]] - `inherits` [EXTRACTED]
