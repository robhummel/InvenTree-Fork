...
## Connections
- [[.get_serializer_context()_8]] - `method` [EXTRACTED]
- [[A generic class for handling stocktake actions.      Subclasses exist for]] - `rationale_for` [EXTRACTED]
...
- [[StockAdd]] - `inherits` [EXTRACTED]
- [[StockChangeStatus]] - `inherits` [EXTRACTED]
- [[StockCount]] - `inherits` [EXTRACTED]
...
- [[StockRemove]] - `inherits` [EXTRACTED]
- [[StockReturn]] - `inherits` [EXTRACTED]
- [[StockStatus]] - `uses` [INFERRED]
- [[StockTransfer]] - `inherits` [EXTRACTED]
