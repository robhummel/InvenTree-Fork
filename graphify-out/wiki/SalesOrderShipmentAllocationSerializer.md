...
# SalesOrderShipmentAllocationSerializer

## Connections
- [[.save()_13]] - `method` [EXTRACTED]
- [[.validate()_7]] - `method` [EXTRACTED]
- [[.validate_shipment()_1]] - `method` [EXTRACTED]
- [[AddressBriefSerializer]] - `uses` [INFERRED]
- [[CompanyBriefSerializer]] - `uses` [INFERRED]
- [[ContactSerializer]] - `uses` [INFERRED]
- [[DRF serializer for allocation of stock items against a sales order  shipment.]] - `rationale_for` [EXTRACTED]
