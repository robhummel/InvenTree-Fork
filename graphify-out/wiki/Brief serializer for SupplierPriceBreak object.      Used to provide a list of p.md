...
# Brief serializer for SupplierPriceBreak object.      Used to provide a list of p
...
- [[PluginRegistryErrorSerializer]] - `rationale_for` [EXTRACTED]
...
- [[SupplierPriceBreakBriefSerializer]] - `rationale_for` [EXTRACTED]
