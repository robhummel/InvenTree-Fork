...
# StockItemTestResultList

## Connections
- [[.perform_create()_4]] - `method` [EXTRACTED]
- [[API endpoint for listing (and creating) a StockItemTestResult object.]] - `rationale_for` [EXTRACTED]
...
- [[ListCreateDestroyAPIView]] - `inherits` [EXTRACTED]
...
- [[StockItemTestResultMixin]] - `inherits` [EXTRACTED]
