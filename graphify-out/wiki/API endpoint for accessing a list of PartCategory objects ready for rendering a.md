...
# API endpoint for accessing a list of PartCategory objects ready for rendering a
...
- [[CategoryTree_1]] - `rationale_for` [EXTRACTED]
...
- [[UserSettingsList]] - `rationale_for` [EXTRACTED]
